...
public class ResolutionAdjuster {
    ...
    public void showSeekBarDialog() {
        ...
        minusButton.setBackgroundResource(android.R.attr.selectableItemBackgroundBorderless);
        ...
        plusButton.setBackgroundResource(android.R.attr.selectableItemBackgroundBorderless);
